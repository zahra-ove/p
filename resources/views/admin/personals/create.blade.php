        ...
        $(document).ready(function () {
            ...
            $('#plusMobile').click(function (e) {
                ...
                $('.mobileList').last().append(`   <span class="col-1 text-center mt-3">
                                                <span class="btn mt-1 p-0 removeMobile" onclick="removeMobile()" data-id="" style="cursor: pointer"><i class="fa fa-minus fa-2x"></i> </span>
                                             </span>`);
...
@section('content')
            ...
            <div class="sub-header mt-3 py-2 px-3 align-self-center d-sm-flex w-100 rounded" style="border-radius: 20px!important;background: #d0e7ff;box-shadow: rgba(0, 0, 0, 0.25) 0px 5px 15px;">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0" style="font-size: 15px">
                        ...
                        <li class="breadcrumb-item active" style="background: #d0e7ff" aria-current="page">افزودن پرسنل</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="container card" style="margin-top: 330px;background-color: gainsboro">
        ...
        <form id="submit" action="{{route('personal.store')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
    ...
    background-color: beige;">
                        ...
                        <div class="col-9 p-0 ">
                            <input class="birthday form-control datePick" name="birthday" id="personalBirthday"
    ...
    background-color: beige;">
                        ...
                        <div class="col-9 p-0 ">
                        <input class="form-control ncode justnumber" name="ncode" autocomplete="off" id="personalNcode">
                    </div>
                    </div>
                    <div class="col-lg-4 mb-3 mt-5 row">
                        <div class="form-label mb-2 col-3 p-0 text-center position-relative" style="
    ...
    background-color: beige;">
                ...
                <div class="col-12 mb-5 mt-5 row" style="margin-bottom: 100px!important;">
                        ...
                        <div class="col-lg-6 mb-3 text-lg-left text-center">
