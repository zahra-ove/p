...
@section("content")
    ...
    <div class="container-fluid">
        <div class="card-header mb-4 text-dark" style="margin-top: 100px">
            ...
            <a class="btn btn-list bg-white  mb-4 bck"
               href="{{route('economic.index')}}" style="float: left">جدول اقتصادی ها
            </a>
            <h5 class="card-title" id="staticBackdropLabel">انتخاب اقتصادی ها</h5>
        </div>

        <table class="align-right table table-hover table-dark table-striped" id="tahator50">
            <form action="{{route('addeconomic')}}" id="tahatorpanjah-form" method="post"
