    ...
    <script>
        $(document).ready(function (e) {
            $('.delete-btn').click(function (e) {
                ...
                $.ajax(
                    {
                        url: "{{asset('admin')}}/deleteporforoosh/" + btnDel,
                        data: info,
                        type: "delete",
            ...
            $('.edited').click(function (e) {
                ...
                $.ajax(
                    {
                        url: "{{asset('admin')}}/editporforoosh/" + btnDel,
                        data: info,
                        type: "post",
                        success: function (data) {
                            if (data == "ok") {
                ...
                @foreach($porforooshes as $key=>$p)
                    <tr data-id="{{$p->id}}">
                        ...
                        <td class="col-2">
                                    ...
                                    <input type="number" min="1" name="ticketNum"  tahatorId="{{$p->id}}" value="{{$p->orders}}" class="w-25 number orders" autocomplete="off">
                        ...
                        <td>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body text-dark" >
                                            ...
                                            <div style="text-align: left">
                                                <button data-dismiss="modal" class="btn text-white btn-danger delete-btn" title="حذف" orders="{{$p->orders}}" data-id="{{$p->id}}" data-toggle="modal" data-target="#delete-modal-{{$key}}">حذف </button>
                            ...
                            <i title="ویرایش" class="fa fa-edit btn btn-warning pt-2 pb-2 edited" data-id="{{$p->id}}">
