    ...
    <div class="container-fluid">
        <div class="card-header mb-4"  style="margin-top: 100px">
            ...
            <a class="btn btn-list  mb-4 bck"
               href="{{route('season.index')}}" target="_blank" style="float: left">جدول فصلی ها
            </a>
            <h5 class="card-title" id="staticBackdropLabel">انتخاب محصولات فصلی</h5>
        </div>

        <table class="align-right table table-hover table-dark table-striped" id="tahator50">
            <form action="{{route('addseason')}}" id="tahatorpanjah-form" method="post"
                        ...
                        <div class="col-sm-12 mb-8">
                            <div class="row">
                                <div class="col-lg-4 col-mb-10 pr-md-0">
                                    ...
                                    <div class="input-group col-11 mb-3">
                                        <div class="input-group-prepend">
                                            <label class="input-group-text" for="season">فصل</label>
                                        </div>
                                        <select name="seasons" class="custom-select select2" id="season">
                                            <option selected>انتخاب کنيد ...</option>
                                            <option value="z">زمستان</option>
                                            <option value="p">پاییز</option>
                                            <option value="t">تابستان</option>
                                            <option value="b">بهار</option>
