...
@if($about!='notfound')
            $('#gallery').append("<img class='single-show-img w-50' style='height: 400px' src='{{asset($about->photo[0]->path)}}'> ");
@endif
            let addpubcheck = [];
////ckeditor
            ...
            $('#file').change(function (e) {
                ...
                reader.onload = (function (theFile) {
                    ...
                    $('#gallery').append("<img class='single-show-img w-50' style='height: 400px' src='" + imgSrc + "'> ");
                });
...
@section('content')
            ...
            <div class="sub-header mt-3 py-2 px-3 align-self-center d-sm-flex w-100 rounded"
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0" style="font-size: 15px">
                        ...
                        <li class="breadcrumb-item active" style="background: #d0e7ff" aria-current="page">تنظیم درباره
                        </li>
                    </ol>
                </nav>
            </div>
    ...
    <!-- END: Breadcrumbs-->
    <!-- START: Form-->
    <form method="post" action="{{route('aboutstore')}}" enctype="multipart/form-data" id="submit">
        @csrf
    ...
    background-color: beige;">
                                <span class="form-label mb-2 position-relative" style="top: 24%">درباره ما</span>
                            </div>
                            <div class="col-10 p-0 ">
                                <textarea name="about_us" class="w-100" style="min-height: 100px">{{$about!='notfound'?$about->about_us:''}}</textarea>
                            </div>
                        </div>
                        <div class="col-12 mb-5 mt-3 row">
                            <div class="form-label mb-2 col-2 p-0 text-center position-relative h-100" style="
    ...
    border-radius: 5px;
    background-color: beige;">
                                <span class="form-label mb-2 position-relative" style="top: 24%">درباره مدیر</span>
                            </div>
                            <div class="col-10 p-0 ">
                                <textarea name="about_boss" class="w-100" style="min-height: 100px">{{$about!='notfound'?$about->about_boss:''}}</textarea>
                            </div>
                        </div>
    ...
    border-radius: 5px;
    background-color: beige;">
                                <span class="form-label mb-2 position-relative" style="top: 24%">نام مدیر</span>
                            </div>
                            <div class="col-9 p-0 ">
                                <input class="form-control" name="boss_name" id="boss_name" value="{{$about!='notfound'?$about->boss_name:''}}" autocomplete="off">
                            </div>
                        </div>
                        <div class="col-12 mb-5 mt-3 row">
