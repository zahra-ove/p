        ...
        <div class="row">
            <div class="col-lg-8 row">
                <div class="col-lg-6 mb-5 mt-5">
                    <label class="form-label mb-2" for="catName">نام دسته بندی</label>
                    <input class="form-control" name="name" autocomplete="off" id="catName">
                </div>
            </div>
                ...
                @foreach($categories as $key=>$category)
                    <tr data-id="{{$category->id}}">
                        ...
                        <td class="text-center">
                            <button class="btn text-white btn-warning" style="padding: 10px 12px" title="ویرایش" data-id="{{$category->id}}" data-toggle="modal" data-target="#edit-modal-{{$key}}"><i class="fas fa-edit"></i> </button>
                            <button class="btn text-white btn-danger" style="padding: 10px 12px" title="حذف" data-id="{{$category->id}}" data-toggle="modal" data-target="#delete-modal-{{$key}}"><i class="fas fa-trash"></i> </button>
                            <!-- modal edit -->
                                                    ...
                                                    <div class="row parent-file">
                                                        <div class="col-lg-8 row">
                                                            <div class="col-md-12 mb-5 mt-5" style="text-align: right;">
                                                                <label class="form-label mb-2" for="submit-ostanname">نام دسته بندی</label>
                                                                <input class="form-control edit-name" name="title" value="{{$category->title}}" autocomplete="off" id="ostanName">
                                                            </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body text-dark" >
                                            <div style="text-align: right">
                                                <p>آیا می خواهید زیردسته {{$category->title}} حذف شود؟</p>
                                            </div>
                                            <div style="text-align: left">
                                                <button data-dismiss="modal" class="btn text-white btn-danger delete-btn" title="حذف" data-id="{{$category->id}}" data-toggle="modal" data-target="#delete-modal-{{$key}}">حذف </button>
