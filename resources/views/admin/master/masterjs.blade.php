...
<script src="{{asset("admin/js/bootstrap-tour-standalone.min.js")}}"></script>
<!--select2 js-->
...
<!--galley js-->
<script src="{{asset("admin/js/lightboxgallery-min.js")}}"></script>
<script src="{{asset("admin/js/jquery.dataTables.js")}}"></script>
<!--carousel js-->
<script src="{{asset("admin/js/owl.carousel.min.js")}}"></script>
<script src="{{asset("admin/js/multiselect.min.js")}}"></script>
<script src="{{asset("admin/js/jquery-clock-timepicker.js")}}"></script>
{{--jquery.switcher--}}
<script src="{{asset("admin/js/jquery.switcher.js")}}"></script>
...
<script>
    $(document).ready(function (){
        ...
        {{--$('.select-items').after('<div class="col-sm-12 col-md-4"><a href="{{route('product.create')}}" class="btn btn-success mb-2 w-25">افزودن</a></div>');--}}
