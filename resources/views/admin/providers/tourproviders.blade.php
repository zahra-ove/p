...
@section('js')
    <script>
        $(document).ready(function (e){
            $('.hrefbtn').attr('href',"{{route('provider.create')}}");
    ...
    <div class="py-5 mt-5 mb-lg-3 row w-100">
        <div class="col-12  align-self-center">
            <div class="sub-header mt-3 py-3 px-3 align-self-center d-sm-flex w-100 rounded">
                <div class="w-sm-100 mr-auto"><h4 class="mb-0">جدول خدمات دهنده های بوم گردی</h4></div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body text-dark" >
                                            <div style="text-align: right">
                                                <p>آیا می خواهید شهر {{$provider->business_title}} حذف شود؟</p>
                                            </div>
