                        ...
                        $.each(JSON.parse(data), function(key, value) {
                            $('#transactionlistmodaltable tbody').append(`
                                                                      <tr>
                                                                         ...
                                                                         <td>${value.naqdtype_equivalent}</td>
...
//===========================start ارسال درخواست لغو رزرو ====================================
            $(document).on('click','#reserve_cancelation',function(e) {
                ...
                let jarime_pay_way = $('#jarime_pay_way option:selected').val();                         // روش پرداخت جریمه
                let returningfish = $('#returningfish')[0].files[0];      // فیش مبلغ بازگشت داده شده به مشتری
                let jarimefish = $('#jarimefish')[0].files[0];            // فیش جریمه پرداخت شده توسط مشتری
                ...
                // اگر جریمه از مبلغ بستانکاری کسر شده باشد و برآیند مبالغ اوکی نباشد ارور بده
                // check for error
                if( (jarime_pay_way == '3') && (parseInt(paid_amount) - parseInt(jarime) != parseInt(returnVajhToCustomer)) ) {
                    e.preventDefault();
