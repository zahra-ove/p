...
`);
            ...
            $("#submit").submit(function (e) {
                ...
                if ($('#finallyPriceInput').val() != 0 || $('#finallyPriceInput').val().length != 0) {
                    ...
                    if ($('#finallyPriceInput').val().replaceAll(",", "") == 0) {
                        if ($('#paytype').val() == 'n') {
...
@section('content')
    ...
    border-radius: 6px;">
            <a href="{{asset('admin/vaziat/'.$order->id.'?taghvim=begin')}}" id="link-begin">
            ...
            <a href="{{asset('admin/vaziat/'.$order->id.'?taghvim=end')}}">
                <div class="row" style="border-bottom: 1px solid #aaaaaa">
            ...
            <a href="{{asset('admin/vaziat/'.$order->id.'?taghvim=recent')}}">
                <div class="row" style="border-bottom: 1px solid #aaaaaa">
                ...
                <div class="sub-header mt-3 py-2 px-3 align-self-center d-sm-flex w-100 rounded"
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0" style="font-size: 15px">
                            ...
                            <li class="breadcrumb-item" style="background: #d0e7ff"><a href="{{route('taghirvaziat')}}">تغییر
                                    وضعیت</a></li>
                            <li class="breadcrumb-item active" style="background: #d0e7ff" aria-current="page">تغییر
                                وضعیت برای
                        </ol>
                    </nav>
                </div>
        ...
        <div class="container card px-5" style="margin-top: 330px;background-color: gainsboro">
            <div class="table-responsive">
                <table class="table table-info mt-5">
                    ...
                    <td>
                        <a href="#" class="btn btn-info" data-toggle="modal" data-target="#detail-modal">جزییات
                            پرداخت</a>
                        <!-- Modal -->
                            ...
                            <div class="col-12 col-lg-6 mt-5 row" style="height: 400px">
                                <div class="col-12 row" style="height: 300px">
                                    <div class="col-12 text-white pt-3"
                                         style="font-size: 16px;height: 60px;background-color: #17a2b8;border-radius: 6px">
                                        شروع تاریخ قدیم: <span
                                            id="ghadimraft">{{$order->raftjalaliFull}}</span></div>
                                    <div class="col-12 text-white pt-3"
                                         style="font-size: 16px;height: 60px;background-color: #6c757d;border-radius: 6px">
                                        پایان تاریخ قدیم: <span
    ...
    background-color: beige;">
                                        ...
                                        <div class="col-9 p-0 ">
                                            <select place name="prereservetype" class="select2 form-control"
                                                    id="Prereserve">
                                    ...
                                    <div class="col-5 mt-3 pt-3"
                                         style="border-top: 1px solid #bdc4c4;text-align: right;"><input
                                            name="totaldovom" class="form-control seprator" id="totaldovom"
                                    ...
                                    <div class="col-5 mt-3 pt-3"
                                         style="border-top: 1px solid #bdc4c4;text-align: right;"><input
                                            name="finallyPrice" class="form-control seprator" id="finallyPriceInput"
                                            autocomplete="off">
