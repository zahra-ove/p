...
////////
                            ...
                            $("#submit").submit(function (e) {
                                ...
                                //  اگر دریافت جریمه نقدی بوده و فیشی واریز نشده، خطا بگیر
                                // if ($('#upload').val().length==0 && $('#pay_type').val() == 'naqd'){
                                //     console.log('جریمه، نقدی داده شده')
                                //     e.preventDefault();
                                //     toastr.warning('فیش واریزی بارگذاری نشده است.');
                                // }

                                if( $('#priceTrans').val() > 0 && $('#upload2').val().length==0 ) {
                                    console.log('مبلغ بازگشتی ، پرداخت شده، فیش آپلود شود.')
                                    e.preventDefault();
                                    toastr.warning('فیش واریزی بارگذاری نشده است.');
                                }
...
@section('content')
    <h2 class="alert-danger">امکان کنسلی رزرو فعال نمی باشد.</h2>
@endsection
@else
@section('content')
    @if($order->status_order_id!='4')
        <div class="py-5 container-fluid mb-lg-3">
            <table class="table table-info" style="text-align:center;">
                ...
                <td>
                    <a href="#" class="btn btn-info" data-toggle="modal" data-target="#detail-modal" style="font-size: 11px;padding: 8px 13px;">جزییات پرداخت</a>
                    <!-- Modal -->
                                        ...
                                        <table class="table">
                                            ...
                                            @foreach($order->aqsat as $key=>$qest)
                                                <tr>
                                                    ...
                                                    <td>{{$qest->vaziat}}</td>
                                                    <td>
                                                        <button class="btn text-white btn-warning btn-fishup" style="padding: 10px 12px" title="فیش" data-id="{{$qest->id}}" data-toggle="modal" data-target="#fish-modal-{{$key}}"><i class="fas fa-money-bill"></i> </button>
                                                        <!-- modal group -->
                                        ...
                                        <table class="table">
                                            ...
                                            @foreach($order->naqditype as $key=>$naqditype)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button class="btn text-white btn-warning fishUp" style="padding: 10px 12px" title="فیش" data-id="{{$naqditype->id}}" data-toggle="modal" data-target="#fish-modal-{{$key}}"><i class="fas fa-money-bill"></i> </button>
                                                        <!-- modal group -->
                                                        <div class="modal fade" id="fish-modal-{{$key}}" role="dialog">
                                        ...
                                        <table class="table table-hover table-striped w-50 m-auto table-bordered">
                                            ...
                                            @foreach($order->aqsat as $key=>$qest)
                                                <tr>
                                                    ...
                                                    <td>{{$qest->vaziat}}</td>
                                                    <td>
                                                        <button class="btn text-white btn-warning fishUp" style="padding: 10px 12px" title="فیش" data-id="{{$qest->id}}" data-toggle="modal" data-target="#qest-modal-{{$key}}"><i class="fas fa-money-bill"></i> </button>
                                                        <!-- modal group -->
                                        ...
                                        <table class="table table-hover table-striped w-50 m-auto table-bordered">
                                            ...
                                            @foreach($order->naqditype as $key=>$naqditype)
                                                <tr>
                                                    ...
                                                    <td>{{number_format($naqditype->mablagh)}} تومان</td>
                                                    <td>
                                                        <span class="btn text-white btn-warning fishUp" style="padding: 10px 12px" title="فیش" data-id="{{$naqditype->id}}" data-toggle="modal" data-target="#naqd-modal-{{$key}}"><i class="fas fa-money-bill"></i> </span>
                                                        <!-- modal group -->
...
">
                                            <th>مبلغ کل</th>
                                            <th>مبلغ جریمه کنسلی</th>
                                            <th>مبلغ بازگشتی کنسلی</th>
                                            <th>نوع پرداخت جریمه</th>
                                            <th>جریمه بابت</th>
                                            <th>فیش جریمه</th>
                                            <th>فیش بازگشت وجه</th>
                                            </thead>
                                            <tbody>
                                            <tr>
                                                <td> مجموع: {{number_format($order->statusmali[0]->bestankar)}} تومان</td>
                                                ...
                                                <td>
                                                    ...
                                                    <select name="pay_type" id="pay_type" style="width: 98%;" style="font-size:11px;">
                                                        <option value="">نوع پرداخت جریمه انتخاب شود</option>
                                                        <option value="naqd">نقد</option>
                                                        <option value="wallet">کسر از کیف پول</option>
                                                    </select>
                                                </td>
                                                <td><textarea name="title" style="width: 98%;"></textarea></td>

                                                <td>
                                                    <label for="upload2" class="btn btn-info" style="white-space: normal;font-size:10px;">فیش بازگشت وجه</label>
                                                    <input type="file" name="fish_bazgasht_vajh" id="upload2" class="d-none fish_bazgasht_vajh" >
                                                </td>

                                                <td>
                                                    <label for="upload" class="btn btn-info" style="font-size:10px;">آپلود فیش جریمه</label>
