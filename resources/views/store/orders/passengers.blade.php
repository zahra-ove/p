            ...
            <table class="align-right table table-hover table-info table-striped mytable w-100">
                ...
                @if($passengers!="notfound")
                    ...
                    @foreach($passengers as $key=>$passenger)
                            ...
                            <input class="d-none porshe" name="id[]" value="{{$passenger->id}}" autocomplete="off">
                        <tr data-id="{{$passenger->id}}">
                            <td class="key-col">{{++$key}}</td>
                            <td>

                                <input name="name[]" class="porshe" id="name" value="{{$passenger->name}}"  autocomplete="off">
                            </td>

                            <td>

                                <input name="family[]" class="porshe" id="family" value="{{$passenger->family}}"  autocomplete="off">
                            </td>
                            <td>

                                <input type="number" name="age[]" class="porshe" id="age" value="{{$passenger->age}}"  autocomplete="off">
                            </td>
                            <td>

                                <input name="ncode[]" class="justnumber porshe"  id="ncode" value="{{$passenger->ncode}}"  autocomplete="off">
                            </td>
