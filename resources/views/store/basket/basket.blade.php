...
let totalfinally=0;
                            ...
                            data.forEach(function (item, index) {
                               ...
                               <img class="rounded-3 mt-3" src="{{asset("")}}/${item.pathImage}" style="width:250px;height:250px;border: 1px solid #d3d3d3 !important" alt="Article img">
                                ...
                                <h3 class="mb-2 fs-lg"><a class="nav-link" href="{{asset("singleproduct")}}/${item.puId}">${item.business_title != null ? item.business_title : '-'}</a></h3>
                                                                ...
                                                                <ul class="mb-0 fs-sm">
                                                                                                                                    <li class="ps-1 list-group-item" style="font-size: 1.1rem !important;"> ${item.productName != null ? item.productName : '-'}  در ${item.cityName != null ? item.cityName : '-'}
                                                                                                                                    <div class="d-inline" style="font-size: 0.9rem !important;">${item.jalali != null ? item.jalali : '-'} </div>
                                                                                                                                    <div class="d-inline" style="font-size: 0.9rem !important;">از  ${item.raft != null ? item.raft : '-'}  تا ${item.bargasht != null ? item.bargasht : '-'}  </div>
                                                                                                                                    </li>


                                                                                                                                                                 <li class="ps-1 list-group-item" style="font-size: 0.9rem !important;text-align: left;"><div class="row"> <div class="col-6" style="text-align:right">تعداد(${item.passengerCount} نفر):</div> <div class="seprate col-6" style="margin-right:-10px"><span
                                                                                                                                                                    data-toggle="modal" data-target="#passenger-modal-${item.id}" style="cursor: pointer;" class="link-info">لیست نفرات</span></div></div>  </li>

                                                                                                                                                                 <li class="ps-1 list-group-item" style="font-size: 0.9rem !important;text-align: left;"><div class="row"> <div class="col-6" style="text-align:right">قیمت کالا:</div> <div class="seprate col-6" style="margin-right:-10px"> ${numberWithCommas(item.price.substring(0, item.price.length - 3))} تومان</div></div></li>
                                                    <li class="ps-1 list-group-item text-danger" style="font-size: 0.9rem !important;text-align: left;"><div class="row"><div class="col-6" style="text-align:right">تخفیف:</div> <div class="seprate col-6" style="margin-right:-10px"> ${item.discount_price != null ? numberWithCommas(item.discount_price.substring(0, item.discount_price.length - 3)) : '-'} تومان</div></div></li>
                                                    <li class="ps-1 list-group-item" style="font-size: 1.1rem !important;text-align: left;"><div class="row"><div class="col-6" style="text-align:right">قیمت نهایی:</div> <div class="seprate col-6" style="margin-right:-10px">${numberWithCommas(item.finally_price)} تومان</div></div></li>
                                                    <li class="ps-1 list-group-item" style="font-size: 1.1rem !important;text-align: left;"><div class="row"><div class="col-6" style="text-align:right"><span class="deletebasket" data-id="${index}"><i title="حذف" class="fas fa-trash-alt" style="cursor: pointer;" data-id="${index}"></i></span></div> <div class="seprate col-6" style="margin-right:-10px"></div></div></li>
                                                                </ul>
                                                                </div>
        ...
        <a href="{{asset('setpassengers')}}/${item.orderdetail_id}" type="button" class="btn btn-secondary">ویرایش</a>
      </div>
                    </div>
                                ...
                                <h3 class="mb-2 fs-lg"><a class="nav-link" href="{{asset("singleproduct")}}/${item.puId}">${item.business_title != null ? item.business_title : '-'}</a></h3>
                                                                ...
                                                                <ul class="mb-0 fs-sm">
                                                                                                                                    ...
                                                                                                                                    <div class="d-inline" style="font-size: 0.9rem !important;">از  ${item.raft != null ? item.raft : '-'}  تا ${item.bargasht != null ? item.bargasht : '-'}  </div>
                                                                                                                                                                 ...
                                                                                                                                                                 <li class="ps-1 list-group-item" style="font-size: 0.9rem !important;text-align: left;"><div class="row"> <div class="col-6" style="text-align:right">تعداد(${item.passengerCount} نفر):</div> <div class="seprate col-6 row" style="margin-right:-10px"><div class="col-8 alert-danger">حتما اطلاعات نفرات را وارد کنید.</div><div class="col-4"><span
                                                                                                                                                                    data-toggle="modal" data-target="#passenger-modal-${item.id}" style="cursor: pointer;" class="link-info">لیست نفرات</span></div></div> </div> </li>
...
item.passengers.forEach(function (item,index) {
    ...
    $(`#tbody-${item.orderdetail_id}`).append(
        ` <tr data-id="${item.id}-${item.orderdetail_id}">
                                                        <td>${++index}</td>
                                                        <td>${item.name!=null?item.name:'نامشخص'}</td>
                                                        <td>${item.family!=null?item.family:'نامشخص'}</td>
                                                        <td>${item.age!=null?item.age:'نامشخص'}</td>
                                                        <td>${item.ncode!=null?item.ncode:'نامشخص'}</td>
                                                        <td>${gender}</td>
                                                    </tr>`
    );
});
...
totalDiscount=parseInt(totalDiscount)+parseInt(item.discount_price);
                                ...
                                $('#payBtn').click(function (et) {
                                    if (item.passengers[0].family==null){
                                        $('#payBtn').attr('href','#');
                                        toastr.error('اطلاعات افراد یکی از رزرو ها ثبت نشده است.')
                          ...
                          $('#price').prepend(`
                          <ul>
<li class="ps-1 list-group-item" style="font-size: 1.1rem !important;"><div class="row"><div class="col-6">قیمت کل:</div><div class="col-6">${numberWithCommas(totalPrice)} تومان</div></div></li>
<li class="ps-1 list-group-item text-danger" style="font-size: 1.1rem !important;"><div class="row"><div class="col-6">تخفیف کل:</div><div class="col-6">${numberWithCommas(totalDiscount)!='NaN'?numberWithCommas(totalDiscount):'-'} تومان</div></div></li>
<li class="ps-1 list-group-item" style="font-size: 1.1rem !important;"><div class="row"><div style="font-size: 1.1rem" class="col-6">قیمت نهایی:</div><div class="col-6">${numberWithCommas(totalfinally)} تومان</div></div></li>
</ul>
                          `)
                            $()
                        ...
                        // else {
                        //     $('.provider-list').append(`<div class="alert-danger">سبد خرید خالی است.</div>`)
                        // }
            ...
            {{--                                                <article class="position-relative row pb-4 pt-4" style="border-top: 1px solid #d3d3d3 !important;">--}}
            {{--                                                    <div class="position-relative col-md-3">--}}
            {{--                                                        <button class="btn btn-icon btn-light-primary btn-xs text-primary rounded-circle position-absolute top-0 end-0 m-3 zindex-5 fav" data-id="${item.id}" style="top:10px!important;left:10px!important" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title="نشان کردن"><i class="fi-heart"></i></button>--}}
...
@section('content')
    ...
    <div class="container-fluid mt-5 pt-5 p-0">
        ...
        <!-- Page content-->
            ...
            {{--                    <h1 class="h2 mb-sm-0">جستجو خدمات استان {{$ostan->name}}</h1><a class="d-inline-block fw-bold text-decoration-none py-1" href="#" data-bs-toggle-class="invisible" data-bs-target="#map"><i class="fi-map me-2"></i>مشاهده نقشه</a>--}}
            {{--                </div>--}}
            <!-- Sorting-->
...
<a href="#" class="btn btn-danger" id="payBtn">ادامه فرآیند خرید</a>
        </div>
