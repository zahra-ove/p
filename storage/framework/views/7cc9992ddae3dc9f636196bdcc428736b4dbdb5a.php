...
//=============================================== PANSION CHANGE START ==================================================
            $('#pansion').on('click change', function (ev) {
                ...
                if($(this).val().length != 0) {
                    ...
                    $.ajax(
                        {
                            url:"<?php echo e(asset('admin/reservetypes')); ?>",
...
//=============================================== DATE CHANGE START ===================================================
            ...
            const findTakht = function() {
                if($('#from').html() !== "" &&  $('#to').html() !== "") {
                    ...
                    $.ajax({
                        url:"<?php echo e(asset('admin/getemptytakhtpansion')); ?>" +'/'+pansionId + '/' + reservId,
                        type: "POST",
...
//=============================================== DATE CHANGE END ===================================================
            $(document).on('change','#takht',function (e){
                ...
                /////modalReserve
                $.ajax({
                    url:"<?php echo e(asset('admin/getorderbytakht')); ?>/" +id,
                    success:function (data) {
            ...
            $('.search-box').keyup(function (e) {
                $('.delete-btn').click(function (e) {
                    ...
                    $.ajax(
                        {
                            url: "<?php echo e(asset('admin')); ?>/freetime/" + btnDel,
                            data: info,
                            type: "delete",
                            success: function (data) {
                                if (data == "ok") {
            ...
            $('.delete-btn').click(function (e) {
                ...
                $.ajax(
                    {
                        url: "<?php echo e(asset('admin')); ?>/tour/" + btnDel,
                        data: info,
                        type: "delete",
                        success: function (data) {
            ...
            $(document).on('click','.plusNaqd',function (echange) {
                ...
                ezaaf = ezaaf + 1;
                $.ajax({
                    url: "<?php echo e(asset("admin/naqdtypes")); ?>",
                    success: function (data) {
                        data.forEach(function (item, index) {
...
<?php $__env->startSection('content'); ?>
    ...
    <!-- START: Form-->
    <form class="h-100 mb-5" method="post" action="<?php echo e(route('order.store')); ?>" id="submit" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
">
    ...
    background-color: beige;">
                                    ...
                                    <select name="user_id" class="select2 form-control" id="user">
                                        ...
                                        <?php if($users!='notfound'): ?>
                                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($user->id); ?>" data-wallet="<?php echo e($user['wallet_mojoodi']); ?>"><?php echo e($user->name); ?> <?php echo e($user->family); ?></option>
                                ...
                                <span>
                                  <a href="<?php echo e(route('createnewuser')); ?>" class="btn btn-secondary">افزودن کاربر</a>
                                </span>
                            ...
                            <div class="col-12 mt-3 row">
                                ...
                                <div class="col-9 p-0 ">
                                    <select class="select2 form-control" id="pansion">
                                        ...
                                        <?php if($pansions!='notfound'): ?>
                                            <?php $__currentLoopData = $pansions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pansion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($pansion->id); ?>"><?php echo e($pansion->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
                                    </select>
                                </div>
                                        ...
                                        <div class="col-10 row">
                                            <div class="col-lg-6 mt-2 px-1">
                                                <select class="form-control naqdtypeTitle" name="naqdtypeTitle[]"
                                                    ...
                                                    <?php $__currentLoopData = $naqdtypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$naqdtype): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($naqdtype->id); ?>"><?php echo e($naqdtype->title); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                            <div class="col-lg-6 mt-2 px-1">
...
<?php echo $__env->make('admin.master.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pansion3\resources\views/admin/reserves/create.blade.php ENDPATH**/ ?>