                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-light" aria-labelledby="navbarDropdown">
                            <?php if(\Illuminate\Support\Facades\Auth::user()->hasPermission('personal_reserve')): ?>
                                ...
                                <a class="dropdown-item" href="<?php echo e(route('tamdidreserve')); ?>">تمدید رزرو</a>
...
<?php /**PATH C:\xampp\htdocs\pansion3\resources\views/admin/master/header.blade.php ENDPATH**/ ?>