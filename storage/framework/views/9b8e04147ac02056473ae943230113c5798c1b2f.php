    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#personalOstan').change(function (e) {
                ...
                $.ajax(
                    {
                        url: "<?php echo e(asset('admin/getcitybyostan')); ?>/" + id,
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container card" style="margin-top: 330px;background-color: gainsboro">
        ...
        <form id="submit" action="<?php echo e(route('storeuser')); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="row">
                            ...
                            <select name="ostan" class="form-control select2" id="personalOstan">
                                ...
                                <?php if($ostans!="notfound"): ?>
                                    <?php $__currentLoopData = $ostans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ostan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($ostan->id); ?>"><?php echo e($ostan->name); ?></option>
                                ...
                                <div class="modal-dialog modal-lg">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <?php if($ncodetypes!='notfound'): ?>
                                                <div class="container-fluid">

                                                    <?php for($i=0;$i<count($ncodetypes);$i++): ?>
                                                        <div class="row" style="border-bottom: 1px solid #aaaa">
                                                            <div class="col-6 my-2" style="text-align: right">
                                                                ...
                                                                <select class="form-control ncodetype">
                                                                    ...
                                                                    <?php $__currentLoopData = $ncodetypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ncodetype): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option
                                                                            value="<?php echo e($ncodetype->id); ?>"><?php echo e($ncodetype->title); ?></option>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </select>
                                                                <label for="attach-<?php echo e($i); ?>"
                                                                       class="btn btn-info mt-2 file-attach-label">انتخاب
                                                                    عکس</label>
                                                                <input name="attach[]" disabled
                                                                       class="d-none file-attach" id="attach-<?php echo e($i); ?>"
                                                                       type="file">
                                                            </div>
...
<?php echo $__env->make('admin.master.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pansion3\resources\views/admin/customs/create2.blade.php ENDPATH**/ ?>