...
//===========================start ارسال درخواست لغو رزرو ====================================
            $(document).on('click','#reserve_cancelation',function(e) {
                ...
                // check for error
                if( parseInt(paid_amount) - parseInt(jarime) != parseInt(returnVajhToCustomer) ) {
                    e.preventDefault();
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container card border-top row" style="margin: 4em auto;" id="jarimeTable">
        <div>
            <table class="table-success table table-hover table-striped m-auto table-bordered">
                <thead style="background: #166618;color: white;">
                    <tr>
                        ...
                        <th>مبلغ پرداخت شده توسط مشتری</th>
                        <th>مبلغ بازگشتی به مشتری</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <label for="returningfish" class="btn btn-info">آپلود فیش واریز</label>
                            <input type="file" id="returningfish" class="d-none" name="returningfish">


                            <label for="jarimefish" class="btn btn-info">آپلود فیش جریمه</label>
...
<?php echo $__env->make('admin.master.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pansion_fatemepc\resources\views/admin/reserves/cancel.blade.php ENDPATH**/ ?>