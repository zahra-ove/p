...
$('#check-out').val(`${bargashtAzMah.date[0]+'/'+bargashtAzMah.date[1]+'/'+bargashtAzMah.date[2]}`);
            ...
            $('#pansions').change(function (es){
                $('#form').attr('action', '<?php echo e(asset('roomlist')); ?>/' + $('#pansions').val());
            });
...
<section class="knsl-banner">
    <div class="knsl-cover-frame">
        <img src="<?php echo e($slider->photo!=null?asset($slider->photo[0]->path):''); ?>" alt="banner" class="knsl-parallax">
    </div>
                ...
                <div class="col-lg-8 align-self-center">
                    <div class="knsl-main-title knsl-mb-40">
                        <div class="knsl-white">
                            ...
                            <!-- main-title -->
                            <h1 class="knsl-mb-20"><?php echo e($slider!='notfound'?$slider->title:''); ?></h1>
                            <div class="knsl-mb-30">
                                <?php echo e($slider!='notfound'?$slider->passage:''); ?>
...
<!-- banner end -->
<?php /**PATH C:\xampp\htdocs\pansion_fatemepc\resources\views/store/master/banner.blade.php ENDPATH**/ ?>